...
import { clientOnlyForBrowserApis } from '../src/rules/nuxt/hydration/clientOnly-for-browser-apis.js';
import type { AstNode, ReportDescriptor, RuleContext } from '../src/types.js';
